...
class Old_Processing:
    ...
    def distance(self):
        ...
        for layer in [1, 2, 3, 4]:
            ...
            # print(os.listdir(self.OLD_DISTANCE_DIR)) 

        if not os.path.exists(os.path.join("output-new-2")):
            os.makedirs(os.path.join("output-new-2"))
        output_filename = os.path.join("output-new-2", "ic_drift.tar.gz")
        with tarfile.open(output_filename, "w:gz") as tar:
            tar.add(self.OLD_DISTANCE_DIR, arcname='.')    
